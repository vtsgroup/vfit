...
Gate produção: v4.4.2 PUBLICADO; health/API/smoke auth pós-deploy aprovados (9 passed, 0 failed, 4 skipped); WhatsApp segue com bypass por Unipile 401.
```
