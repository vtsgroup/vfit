...
- **Deploy liberado pelo smoke auth:** após renovação dos tokens, `npm run smoke:auth:local` passou com 8 checks aprovados, 0 falhas e 4 skips por mutações desabilitadas. Próximo passo operacional: deploy patch v4.3.8 com seed automática na base ativa.
