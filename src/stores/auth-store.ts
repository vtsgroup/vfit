...
interface AuthState {
  ...
  /** true quando a superfície de boot atual renderizou conteúdo real (dashboard, app B2C,
   *  welcome anônimo, login). A splash só sai com isSessionReady && isBootResolved — ela é
