  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var s=localStorage.getItem('vfit-app')||localStorage.getItem('personal-ia-app');var isLight=false;if(s){var p=JSON.parse(s),t=(p.state||{}).resolvedTheme;if(t==='light'){isLight=true;document.documentElement.classList.add('light');document.documentElement.style.colorScheme='light'}else{document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark'}}else{document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark'}var b=isLight?'#f7fbfa':'#050A12';var tc=isLight?'#f6f9fb':'#050A12';document.documentElement.style.backgroundColor=b;if(isLight){requestAnimationFrame(function(){requestAnimationFrame(function(){var m=document.querySelectorAll('meta[name="theme-color"]');for(var i=0;i<m.length;i++)m[i].content=tc})})}else{var m=document.querySelectorAll('meta[name="theme-color"]');for(var i=0;i<m.length;i++)m[i].content=tc}}catch(e){document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark';document.documentElement.style.backgroundColor='#050A12'}})();`,
          }}
        />
