...
const Icons = {
  search: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>,
  settings: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>,
  bell: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>,
  logout: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>,
  menu: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="18" x2="20" y2="18"/></svg>,
  home: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,
  edit: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>,
  copy: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>,
  trash: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>,
  gift: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13"/><path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5"/></svg>,
  plus: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>,
  check: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"/></svg>,
  x: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>,
  users: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
  message: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>,
  chart: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>,
  dollar: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="2" x2="12" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
  wallet: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/></svg>,
  link: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>,
  qrcode: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="5" height="5" x="3" y="3" rx="1"/><rect width="5" height="5" x="16" y="3" rx="1"/><rect width="5" height="5" x="3" y="16" rx="1"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><path d="M21 21v.01"/><path d="M12 7v3a2 2 0 0 1-2 2H7"/><path d="M3 12h.01"/><path d="M12 3h.01"/><path d="M12 16v.01"/><path d="M16 12h1"/><path d="M21 12v.01"/><path d="M12 21v-1"/></svg>,
  download: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>,
  filter: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>,
  chevronDown: (p: IconProps) => <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>,
  externalLink: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>,
  brain: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M17.599 6.5a3 3 0 0 0 .399-1.375"/><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"/><path d="M3.477 10.896a4 4 0 0 1 .585-.396"/><path d="M19.938 10.5a4 4 0 0 1 .585.396"/><path d="M6 18a4 4 0 0 1-1.967-.516"/><path d="M19.967 17.484A4 4 0 0 1 18 18"/></svg>,
  sparkles: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>,
  wand: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8 19 13"/><path d="M15 9h0"/><path d="M17.8 6.2 19 5"/><path d="m3 21 9-9"/><path d="M12.2 6.2 11 5"/></svg>,
  messageAI: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 6V2H8"/><path d="m8 18-4 4V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2Z"/><path d="M2 12h2"/><path d="M9 11v2"/><path d="M15 11v2"/><path d="M20 12h2"/></svg>,
  image: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>,
  barChart: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></svg>,
  lock: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>,
  sun: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>,
  moon: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>,
  monitor: (p: IconProps) => <svg width={p.size||20} height={p.size||20} viewBox="0 0 24 24" fill="none" stroke={p.color||"currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>,
  aiBot: (p: IconProps) => {
    const s = p.size || 24
...
function Btn({ variant = 'primary', size = 'md', children, t, icon, onClick }: {
  ...
  const base: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: s.ip, padding: s.p, border: 'none', borderRadius: s.br, fontWeight: 600, fontSize: s.fs, lineHeight: 1, cursor: 'pointer', userSelect: 'none', transition: 'transform 150ms cubic-bezier(0.16,1,0.3,1), box-shadow 150ms cubic-bezier(0.16,1,0.3,1)', fontFamily: 'inherit' }

  let st: React.CSSProperties = base
  if (variant === 'primary') {
    st = { ...base, background: `linear-gradient(180deg, ${isHover ? t.primaryLighter : t.primaryLight} 0%, ${isHover ? t.primaryLight : t.primary} 50%, ${isHover ? t.primary : t.primaryDark} 100%)`, color: '#fff', boxShadow: isActive ? t.btn3dPrimaryActive : isHover ? t.btn3dPrimaryHover : t.btn3dPrimary, textShadow: '0 1px 2px rgba(0,0,0,0.15)', transform: isActive ? 'translateY(3px)' : isHover ? 'translateY(-1px)' : 'translateY(0)' }
  } else if (variant === 'secondary') {
    st = { ...base, background: `linear-gradient(180deg, ${isHover ? t.secondaryLighter : t.secondaryLight} 0%, ${isHover ? t.secondaryLight : t.secondary} 50%, ${isHover ? t.secondary : t.secondaryDark} 100%)`, color: '#fff', boxShadow: isActive ? t.btn3dSecondaryActive : isHover ? t.btn3dSecondaryHover : t.btn3dSecondary, textShadow: '0 1px 2px rgba(0,0,0,0.15)', transform: isActive ? 'translateY(3px)' : isHover ? 'translateY(-1px)' : 'translateY(0)' }
    ...
    st = { ...base, background: isHover ? t.surfaceHover : t.surface, color: t.textSecondary, border: `1.5px solid ${isHover ? t.neutral300 : t.neutral200}`, boxShadow: isActive ? `0 0 0 ${t.neutral200}` : isHover ? `0 3px 0 ${t.neutral200}, 0 6px 12px rgba(0,0,0,0.06)` : `0 2px 0 ${t.neutral200}, 0 4px 8px rgba(0,0,0,0.04)`, transform: isActive ? 'translateY(2px)' : isHover ? 'translateY(-1px)' : 'translateY(0)' }
  ...
  return (
    <button onMouseEnter={() => setState('hover')} onMouseLeave={() => setState('idle')} onMouseDown={() => setState('active')} onMouseUp={() => setState('hover')} onClick={onClick} style={st}>
      {icon}{children}
    </button>
  )
}

function Card({ children, t, hover = true, style = {} }: { children: React.ReactNode; t: Theme; hover?: boolean; style?: React.CSSProperties }) {
...
function ActionBtn({ icon: I, t, destructive, tooltip }: { icon: (p: IconProps) => React.JSX.Element; t: Theme; destructive?: boolean; tooltip?: string }) {
  const [h, setH] = useState(false)
  return (
    ...
    }}><I size={16} color="currentColor" /></button>
  )
}

function DSBadge({ type, children, t }: { type: string; children: React.ReactNode; t: Theme }) {
...
function CustomSelect({ t, options, value, onChange }: { t: Theme; options: { value: string; label: string }[]; value: string; onChange: (v: string) => void }) {
  ...
  return (
    <div style={{ position: 'relative', minWidth: 180 }}>
      <button onClick={() => setOpen(!open)} style={{
        width: '100%', padding: '12px 16px', background: t.surface, backdropFilter: t.backdrop,
        border: `1.5px solid ${open ? t.borderFocus : t.border}`, borderRadius: 14, display: 'flex',
        alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', fontSize: 14,
        fontWeight: 500, color: t.text, boxShadow: t.selectShadow, fontFamily: 'inherit',
        transition: 'border-color 200ms ease',
      }}>
        <span>{selected?.label}</span>
        <span style={{ transform: open ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 200ms ease', display: 'flex' }}>
      ...
      {open && (
        <div style={{
          ...
          background: t.surfaceSolid, border: `1.5px solid ${t.border}`, borderRadius: 14,
          boxShadow: t.cardShadowHover, overflow: 'hidden',
          animation: 'fadeInUp 200ms cubic-bezier(0.16,1,0.3,1) both',
        }}>
          {options.map((opt) => (
            <div key={opt.value} onMouseEnter={() => setHov(opt.value)} onMouseLeave={() => setHov(null)}
              onClick={() => { onChange(opt.value); setOpen(false) }}
              style={{
                padding: '10px 16px', cursor: 'pointer', fontSize: 14, fontWeight: 500,
                color: opt.value === value ? t.primary : t.text,
                background: hov === opt.value ? t.primaryBg : opt.value === value ? t.neutral50 : 'transparent',
...
function SlidingTabs({ t, tabs, activeTab, onTabChange }: { t: Theme; tabs: { id: string; label: string }[]; activeTab: string; onTabChange: (id: string) => void }) {
  const activeIndex = tabs.findIndex((tab) => tab.id === activeTab)
  return (
    <div style={{ display: 'inline-flex', background: t.neutral100, borderRadius: 14, padding: 4, position: 'relative' }}>
      <div style={{
        position: 'absolute', top: 4, left: `calc(${activeIndex * (100 / tabs.length)}% + 4px)`,
        width: `calc(${100 / tabs.length}% - 8px)`, height: 'calc(100% - 8px)',
        background: `linear-gradient(180deg, ${t.primaryLight}, ${t.primary})`,
        borderRadius: 10, boxShadow: `0 2px 0 ${t.primaryDark}`,
        transition: 'left 300ms cubic-bezier(0.16,1,0.3,1)',
      }} />
      {tabs.map((tab) => (
        <button key={tab.id} onClick={() => onTabChange(tab.id)} style={{
          position: 'relative', zIndex: 1, padding: '10px 22px', border: 'none', borderRadius: 10,
          background: 'transparent', cursor: 'pointer', fontSize: 13, fontWeight: 600,
          color: tab.id === activeTab ? '#fff' : t.textMuted, fontFamily: 'inherit',
...
function ProgressBar({ value, max }: { value: number; max: number }) {
  ...
  return (
    <div style={{ width: '100%', height: 10, borderRadius: 8, background: 'rgba(128,128,128,0.15)', overflow: 'hidden' }}>
      <div style={{
        width: `${pct}%`, height: '100%', borderRadius: 8,
        background: 'linear-gradient(90deg, #10b981, #34d399)', backgroundSize: '200% 100%',
        animation: 'shimmer 2s ease-in-out infinite', transition: 'width 600ms cubic-bezier(0.16,1,0.3,1)',
      }} />
    </div>
  )
}

function AIBotFAB({ t }: { t: Theme }) {
  const [h, setH] = useState(false)
  return (
        ...
        <div style={{ maxWidth: 1060, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32, animation: 'fadeInUp 400ms cubic-bezier(0.16,1,0.3,1) both' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: -0.5 }}>VFIT Design System</h1>
          ...
          {/* ---- SHOWCASE BANNER ---- */}
          <Link href="/dashboard/admin/design-system/showcase" style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', marginBottom: 24, borderRadius: 16, background: `linear-gradient(135deg, ${t.primaryLight}22, ${t.primary}11)`, border: `1px solid ${t.primaryLight}33`, textDecoration: 'none', color: t.text, transition: 'all 200ms ease' }}>
            <span style={{ fontSize: 20 }}>🎨</span>
            <div style={{ flex: 1 }}>
              <span style={{ fontWeight: 700, fontSize: 14 }}>Design System v4 — Showcase Interativo</span>
              <p style={{ fontSize: 12, color: t.textMuted, marginTop: 2 }}>70+ componentes com demos ao vivo · ARIA, Focus Trap, Glassmorphism, Tokens</p>
            </div>
            <Icons.externalLink size={18} color={t.primary} />
          </Link>
          ...
          {section === 'buttons' && (
            <div style={{ animation: 'fadeInUp 400ms cubic-bezier(0.16,1,0.3,1) both' }}>
              ...
              {[
                { title: 'Primary (Verde)', variant: 'primary' as const, examples: [{ s: 'sm' as const, t: 'Copiar' }, { s: 'md' as const, t: 'Aplicar simulação' }, { s: 'lg' as const, t: '+ Nova Cobrança', icon: <Icons.plus size={18} color="#fff" /> }] },
                { title: 'Secondary (Slate)', variant: 'secondary' as const, examples: [{ s: 'sm' as const, t: 'Copiar Link', icon: <Icons.copy size={14} color="#fff" /> }, { s: 'md' as const, t: 'Voltar para Super Admin' }, { s: 'lg' as const, t: 'Saques PIX', icon: <Icons.download size={18} color="#fff" /> }] },
                { title: 'Warning (Amber — Financeiro)', variant: 'warning' as const, examples: [{ s: 'sm' as const, t: 'Cobrar' }, { s: 'md' as const, t: '+ Nova Cobrança', icon: <Icons.plus size={16} color="#fff" /> }] },
                { title: 'Danger (Vermelho)', variant: 'danger' as const, examples: [{ s: 'sm' as const, t: 'Excluir', icon: <Icons.trash size={14} color="#fff" /> }, { s: 'md' as const, t: 'Remover Aluno' }] },
                { title: 'Ghost (Outline)', variant: 'ghost' as const, examples: [{ s: 'sm' as const, t: 'QR Code', icon: <Icons.qrcode size={14} /> }, { s: 'md' as const, t: 'Copiar Link', icon: <Icons.link size={16} /> }, { s: 'md' as const, t: 'Desativar' }] },
              ].map((group) => (
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {['Todas', 'Hipertrofia', 'Emagrecimento', 'Funcional', 'Cardio'].map((pill, i) => (
                    <span key={pill} style={{
                      ...
                      background: i === 0 ? `linear-gradient(180deg, ${t.primaryLight}, ${t.primary})` : t.neutral50,
                      border: i === 0 ? `1.5px solid ${t.primaryDark}` : `1.5px solid ${t.border}`,
                      boxShadow: i === 0 ? `0 2px 0 ${t.primaryDarker}, 0 4px 8px rgba(5,150,105,0.25)` : 'none',
                    }}>{pill}</span>
                  ))}
                </div>
              </Card>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                          ...
                          {user.badges.map((b) => <DSBadge key={b} type={b} t={t}>{b.replace('-', ' ')}</DSBadge>)}
                          {user.verified && <DSBadge type="verified" t={t}>Verificado</DSBadge>}
                        </div>
                ...
                <div style={{ padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${t.borderLight}` }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <span style={{ fontWeight: 700, fontSize: 16 }}>VFIT</span>
                    </div>
