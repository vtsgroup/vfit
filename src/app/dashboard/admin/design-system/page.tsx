...
const themes = {
  ...
  dark: {
    ...
    secondaryLighter: '#d4d4d8',
    secondaryDark: '#52525b',
    secondaryDarker: '#3f3f46',
    ...
    btn3dSecondary: '0 4px 0 #18181b, 0 6px 18px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.2)',
    btn3dSecondaryHover: '0 6px 0 #18181b, 0 10px 28px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.25)',
    btn3dSecondaryActive: '0 1px 0 #18181b, 0 2px 8px rgba(0,0,0,0.5), inset 0 2px 4px rgba(0,0,0,0.3)',
    backdrop: 'blur(20px)',
  },
}
          ...
          {section === 'buttons' && (
            <div style={{ animation: 'fadeInUp 400ms cubic-bezier(0.16,1,0.3,1) both' }}>
              ...
              {([
                ...
                { title: 'Secondary (Zinc)', variant: 'secondary' as const, desc: 'Acao secundaria — zinc neutro com profundidade 3D, alto contraste em dark mode', examples: [
