...
export default function TreinosPage() {
  ...
  return (
    <div className="mx-auto max-w-lg animate-in fade-in-0 slide-in-from-bottom-2 duration-300 px-4 pt-0 pb-24">
      {/* ─── Header ─── */}
      <div className="-mx-4 mb-5 rounded-b-3xl border-b-0 bg-gradient-to-b from-[#0B1627] via-[#0A1220] to-[#050A12] px-4 py-5 backdrop-blur-md shadow-[0_4px_24px_0_rgba(10,18,32,0.45)]">
        <p className="text-xs font-semibold text-emerald-400">
          {(() => { const h = new Date().getHours(); return h < 12 ? 'Bom dia' : h < 18 ? 'Boa tarde' : 'Boa noite' })()}
        </p>
        <h1 className="bg-gradient-to-r from-vfit-primary-100 to-vfit-primary-400 bg-clip-text text-4xl font-black text-transparent">
          Treinos
        </h1>
