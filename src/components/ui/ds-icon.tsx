 ...
 *
 * DSIcon — VFIT Design System v3 Icon System
 *
 * Exports: DS_ICON_NAMES, DSIconName, DSIconProps, DSIcon
 */

// ============================================
// DSIcon — VFIT Design System v3 Icon System
// 33 premium hand-crafted SVG icons extracted from
// vfit-design-system-v2.jsx (SINGLE SOURCE OF TRUTH)
//
// Usage:
...
export const DS_ICON_NAMES = [
  'search', 'settings', 'bell', 'logout', 'menu', 'home',
  'edit', 'copy', 'trash', 'gift', 'plus', 'check', 'x',
  'users', 'message', 'chart', 'dollar', 'wallet', 'link',
  'qrcode', 'download', 'filter', 'chevronDown', 'chevronLeft', 'chevronRight', 'externalLink',
  'brain', 'sparkles', 'wand', 'messageAI', 'image', 'barChart',
  'lock', 'sun', 'moon', 'monitor', 'aiBot',
  'crown', 'creditCard', 'calendar', 'arrowRight', 'arrowUpRight',
  'trendingUp', 'refresh', 'userCheck', 'key',
  'userPlus', 'loader', 'dumbbell', 'flame', 'coin', 'trophy',
  'clock', 'shieldCheck', 'shieldOff', 'shieldBan',
  'user', 'shoppingBag', 'bookOpen', 'checkCircle', 'play',
  'info', 'heart', 'star', 'arrowLeft',
  'receipt', 'building', 'arrowDownRight', 'alertTriangle', 'rotateCcw',
  'xCircle', 'ban', 'fileText', 'scan', 'send',
  'eye', 'eyeOff', 'shield', 'percent', 'mapPin', 'phone', 'upload',
  'award', 'link2', 'share',
  'ruler', 'scale', 'activity', 'camera',
  'clipboardList', 'flask',
  'bellOff', 'checkCheck', 'palette', 'save', 'bellRing',
  // Batch 7 — full coverage (auth, public, components)
  'arrowDown', 'arrowUp', 'chevronUp', 'circle', 'globe', 'hash', 'mail',
  'fingerprint', 'logIn', 'bot', 'lightbulb', 'messageCircle', 'rocket',
  'playCircle', 'plusCircle', 'video', 'images', 'userRound', 'smartphone',
  'wifiOff', 'wifi', 'wrench', 'cookie', 'gavel', 'server', 'helpCircle',
  'tag', 'code2', 'instagram', 'megaphone', 'keyRound', 'shieldAlert',
  'skipForward', 'volume2', 'volumeX', 'snowflake', 'bug', 'clipboardCopy',
  'uploadCloud', 'heartHandshake', 'inbox', 'expand', 'eraser', 'pause',
  'penLine', 'sendHorizontal', 'typeIcon', 'archive', 'arrowDownToLine',
  'checkCircle2', 'dollarSign', 'layers', 'brainCircuit', 'calendarDays',
  'calendarCheck', 'calendarClock', 'database', 'userX', 'briefcase',
  'graduationCap', 'pencil', 'medal', 'smile', 'meh', 'frown', 'droplets',
  'qrCode2', 'messageSquareHeart', 'fileDown', 'fileSpreadsheet', 'footprints',
  'gripVertical', 'layoutDashboard', 'library', 'shoppingCart', 'slidersHorizontal',
  'stickyNote', 'toggleRight', 'triangle', 'userCog', 'wind', 'youtube',
  'atom', 'command', 'cloud', 'cpu', 'scrollText', 'alertCircle',
  // Batch 8 — remaining migration icons
  'target', 'messageSquare', 'zap',
  // Batch 10 — bottom nav VFIT
  'apple',
...
const ICON_PATHS: Record<Exclude<DSIconName, 'aiBot'>, string> = {
  ...
  messageAI: '<path d="M12 6V2H8"/><path d="m8 18-4 4V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2Z"/><path d="M2 12h2"/><path d="M9 11v2"/><path d="M15 11v2"/><path d="M20 12h2"/>',
  ...
  coin: '<circle cx="12" cy="12" r="9"/><ellipse cx="12" cy="12" rx="5" ry="9"/><path d="M3.6 9h16.8"/><path d="M3.6 15h16.8"/><path d="M12 7.5v9"/><path d="M9.75 10.25c.42-.78 1.18-1.2 2.25-1.2 1.38 0 2.3.67 2.3 1.74 0 2.42-4.6 1.12-4.6 3.44 0 1.05.92 1.72 2.3 1.72 1.09 0 1.87-.41 2.3-1.2"/>',
  ...
  shieldBan: '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M14.5 9.5 9.5 14.5"/>',
  ...
  receipt: '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>',
  ...
  bellOff: '<path d="M8.7 3A6 6 0 0 1 18 8a21.3 21.3 0 0 0 .6 5"/><path d="M17 17H3s3-2 3-9a4.67 4.67 0 0 1 .3-1.7"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><line x1="2" x2="22" y1="2" y2="22"/>',
  ...
  code2: '<path d="m16 18 6-6-6-6"/><path d="m8 6-6 6 6 6"/>',
  ...
  typeIcon: '<path d="M12 4v16"/><path d="M4 7V5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2"/><path d="M9 20h6"/>',
  ...
  qrCode2: '<rect width="5" height="5" x="3" y="3" rx="1"/><rect width="5" height="5" x="16" y="3" rx="1"/><rect width="5" height="5" x="3" y="16" rx="1"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><path d="M21 21v.01"/><path d="M12 7v3a2 2 0 0 1-2 2H7"/><path d="M3 12h.01"/><path d="M12 3h.01"/><path d="M12 16v.01"/><path d="M16 12h1"/><path d="M21 12v.01"/><path d="M12 21v-1"/>',
...
const STROKE_WIDTH_OVERRIDES: Partial<Record<DSIconName, number>> = {
  check: 2.5,
  chevronDown: 2.5,
  chevronLeft: 2.5,
  chevronRight: 2.5,
...
// ─── Default size overrides (from JSX source) ─

const DEFAULT_SIZE_OVERRIDES: Partial<Record<DSIconName, number>> = {
  chevronDown: 16,
  chevronLeft: 16,
  chevronRight: 16,
}
...
export function DSIcon({
  ...
  // AI Bot is a special icon with fill instead of stroke
  if (name === 'aiBot') {
    return (
      <svg
        width={resolvedSize}
      ...
      >
        <rect x="4" y="8" width="24" height="18" rx="5" stroke={color} strokeWidth="2" />
        <circle cx="12" cy="17" r="2.5" fill={color} />
        <circle cx="20" cy="17" r="2.5" fill={color} />
        <path d="M12 22c0 0 2 2.5 4 2.5s4-2.5 4-2.5" stroke={color} strokeWidth="1.8" strokeLinecap="round" />
        <path d="M16 8V4" stroke={color} strokeWidth="2" strokeLinecap="round" />
        <circle cx="16" cy="3" r="1.5" fill={color} />
        <path d="M4 15H2" stroke={color} strokeWidth="2" strokeLinecap="round" />
        <path d="M30 15h-2" stroke={color} strokeWidth="2" strokeLinecap="round" />
      </svg>
    )
  }
