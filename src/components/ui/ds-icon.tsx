...
const ICON_PATHS: Record<Exclude<DSIconName, 'aiBot'>, string> = {
  ...
  coin: '<circle cx="12" cy="12" r="8.75"/><circle cx="12" cy="12" r="5.65"/><path d="M12 7.75v8.5"/><path d="M9.7 10.25c.43-.78 1.18-1.18 2.3-1.18 1.32 0 2.16.62 2.16 1.58 0 2.18-4.32.98-4.32 3.02 0 .94.84 1.54 2.16 1.54 1.1 0 1.88-.38 2.32-1.14"/>',
