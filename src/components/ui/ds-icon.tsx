...
const ICON_PATHS: Record<Exclude<DSIconName, 'aiBot'>, string> = {
  ...
  coin: '<circle cx="12" cy="12" r="9"/><path d="M12 7v10"/><path d="M15 9.5c-.62-.78-1.58-1.16-3-1.16-1.7 0-2.75.68-2.75 1.78 0 1.16 1.05 1.58 2.75 1.84 1.78.27 2.75.76 2.75 1.98 0 1.14-1.06 1.82-2.75 1.82-1.42 0-2.48-.42-3.2-1.25"/><circle cx="12" cy="12" r="5.8" opacity="0.28"/>',
  ...
  wheat: '<path d="M12 22V2"/><path d="M8 6c0-2 1.5-3.5 4-4 0 2.5-1.5 4-4 4Z"/><path d="M16 6c0-2-1.5-3.5-4-4 0 2.5 1.5 4 4 4Z"/><path d="M7 11c0-2 2-3.6 5-4 0 2.8-2 4-5 4Z"/><path d="M17 11c0-2-2-3.6-5-4 0 2.8 2 4 5 4Z"/><path d="M7 16c0-2 2-3.6 5-4 0 2.8-2 4-5 4Z"/><path d="M17 16c0-2-2-3.6-5-4 0 2.8 2 4 5 4Z"/>',
