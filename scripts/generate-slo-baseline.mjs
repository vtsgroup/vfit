...
const outputPath = resolve(root, 'docs/ULTRA-PLANO-MVP-PRODUCAO/SLO-SLA-BASELINE.generated.md')
const now = new Date().toISOString()

const markdown = `# SLO/SLA Baseline (Gerado automaticamente)
...
console.log(`SLO baseline gerado em: ${outputPath}`)
